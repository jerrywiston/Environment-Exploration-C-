...
################################### Exploration Model ###################################
# Map-based Exploration Q Network
...
# DDPG
class ActorExp(nn.Module):
    def __init__(self, feature_size=(64,64)):
        super(ActorExp, self).__init__()
        self.conv1 = nn.Conv2d(3, 32, kernel_size=5, stride=2)
        self.bn1 = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(32, 64, kernel_size=5, stride=2)
        self.bn2 = nn.BatchNorm2d(64)
        ...
        self.fc4 = nn.Linear(linear_input_size, 128)
    ...
    def forward(self, s, device):
        ...
        a_out = torch.tanh(self.fc5(h_fc4))
        return a_out

class CriticExp(nn.Module):
    def __init__(self, feature_size=(64,64)):
        super(CriticExp, self).__init__()
        self.conv1 = nn.Conv2d(3, 32, kernel_size=5, stride=2)
        self.bn1 = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(32, 64, kernel_size=5, stride=2)
        self.bn2 = nn.BatchNorm2d(64)
...
class Actor(nn.Module):
    ...
    def forward(self, s, device):
        ...
        a_out = torch.tanh(self.fc3(h_fc2))
        return a_out
...
class Critic(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(60, 128)
        self.fc2_s = nn.Linear(130, 64)
        self.fc2_a = nn.Linear(2, 64)
